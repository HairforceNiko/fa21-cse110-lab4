...
17. The result will be [2,4,6]. We push every value in [1, 2, 3] into callback which represents doSomething function, and we return (num*2) back and push back into newArr[] which is [2,4,6]. <br /> <br />
19. The output is:<br />
1 <br />
4 <br />
3 <br />
